---
title: "Lab 1: Dartboard Statistics Part 2"
jupyter: python3
---
...
plt.xlabel("Bins")
plt.ylabel("Counts")
plt.hist(my_strikes, np.arange(-20,21, 1), range=(-20,20), label="Dart Strikes")
...
plt.xlabel("Bins")
plt.ylabel("Counts")
plt.hist(fixed_strikes, np.arange(-20,21, 1), label="Dart Strikes")
...
The class p-value is astronomically small, which means we reject our null hypothesis that the data follows a normal distribution. This is mainly due to the fac that the $\chi^2$ test is far too sensitive for large sample sizes whereas our data is larger larger than a typical significance level of 0.05 meaning it doesnt reject the null hypothesis and is normally distributed according to our null hypothesis. 
